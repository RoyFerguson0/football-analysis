        ...
        for object, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in object_tracks[frame_num].items():
                    ...
                    # If track in first frame but not in last frame we continue and don't do anything with this players calculation.
                    ...
                    # Start and end position is going to be none when user is outside trapezoidal shape that is outside view transformer then don't measure speed.
